...
import type { MultiplayerActions } from '../hooks/useMultiplayerGame';
...
export default function WaitingRoom({ state, actions }: WaitingRoomProps) {
  ...
  const [selectedPreset, setSelectedPreset] = useState<string>(wordListKey);
      ...
      {isHost ? (
        ...
        <section className="mm-mp-card">
          ...
          <div className="mm-waiting-config-readonly">
            ...
            <p>
              Liste :{' '}
              {readonlyWordList.name || readonlyWordListKey}
            </p>
